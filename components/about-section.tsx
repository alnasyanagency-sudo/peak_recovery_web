...
const IMAGES: {
  reception: string
  hallway: StaticImageData
  office: StaticImageData
} = {
  reception:
    "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WhatsApp%20Image%202026-04-19%20at%209.26.13%20AM-UcyBZNN7IwdHNQmjYEjriIpBhH2tME.jpeg",
  hallway: img1,
  office: img2,
}
      ...
      <div className="container mx-auto px-[16px] lg:px-[60px] grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="order-1 lg:order-2">
          ...
          <p className="text-gray-500 leading-relaxed mb-8">
            في مركز قمة التعافي، نؤمن إن الحجامة مو بس علاج — هي أسلوب حياة صحّي مبني على السنّة النبوية الشريفة.
            فريقنا يجمع بين الخبرة الطويلة والاهتمام بأدق التفاصيل، من التعقيم الكامل إلى توفير بيئة مريحة تحسّ فيها
            بالخصوصية والأمان. عندنا أقسام منفصلة للرجال والنساء، وكل جلسة مصمّمة بعناية لأن صحّتك تستاهل الأفضل.
          </p>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {features.map((feature, index) => {
              const isHighlighted =
                feature.icon === "fa-user-nurse" || feature.icon === "fa-spa"
